...
if (rerun_models) {
  ...
  write_rds(narrow_bridge, "05-narrow_bridge.rds")
  
  wide_bridge   <- bridge_sampler(fit_wide_4Bridge, silent = T)
  write_rds(wide_bridge, "05-wide_bridge.rds")
  
} else {
  narrow_bridge <- read_rds("05-narrow_bridge.rds")  
  wide_bridge <- read_rds("05-wide_bridge.rds")
}
