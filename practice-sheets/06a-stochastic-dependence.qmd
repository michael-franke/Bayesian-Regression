...
Ideally, write a single that takes a data set as input and output information that tells you about whether $X$ and $Y$ are independent.
...
In data set 2, $X$ and $Y$ are not stochastically independent, and stay independent given $Z$.
...
Data set 1 is likely from a chain, because $X$ and $Y$ are not stochastically independent, but turn independent given $Z$.

Data set 2 is likely from a fork, because $X$ and $Y$ are not stochastically independent, and stay independent given $Z$.

Data set 3 is likely from a collider, because $X$ and $Y$ are stochastically independent, but cease to be given $Z$.
