...
data_radon |> 
  ...
  annotate("text", x = empirical_mean - 0.4, y = 70, label = "grand mean", color = project_colors[2], size = 13) +
  annotate("text", x = emp_mean_of_means + 0.5, y = 20, label = "mean-of-means", color = project_colors[3], size = 13) +
...
<span style = "color:darkgreen"> add an exercise if you can </span>  
