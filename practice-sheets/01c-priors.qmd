...
This tutorial covers how to inspect, set and sample priors in Bayesian regression models with `brms`. The main conceptual take-home message is: The choice of prior should be informed by their effect on the prior predictive distribution. How to obtain samples from the prior predictive distribution is covered in a separate chapter.
